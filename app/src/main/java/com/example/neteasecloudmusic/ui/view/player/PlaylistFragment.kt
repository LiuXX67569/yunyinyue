...
class PlaylistFragment : DialogFragment(), PlaylistAdapter.OnItemClickListener {
    ...
    override fun onCreateView(
        ...
        playlistAdapter = PlaylistAdapter((musicList as? ArrayList<MusicBean>)?.toList() ?: emptyList(), this)
    ...
    override fun onItemClick(position: Int) {
        ...
        (activity as? MusicPlayerActivity)?.handlePlaylistItemClick(position)
    }
    ...
    companion object {
        fun newInstance(musicList: ArrayList<MusicBean>): PlaylistFragment {
